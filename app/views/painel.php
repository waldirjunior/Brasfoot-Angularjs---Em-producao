...
<div data-ng-controller="painelCtrl">
      <div class="panel panel-default">
        <div class="media v-middle">
          <div class="media-left">
            <div class="bg-green-400 text-white">
              <div class="panel-body">
                <i class="fa fa-soccer-ball-o fa-fw fa-2x"></i>
              </div>
            </div>
          </div>
          <div class="media-body">
            Sua última partida foi em: <span class="text-body-2">{{date | date:'yyyy-MM-dd'}}</span>
          </div>
          <div class="media-right media-padding">
            <a class="btn btn-white paper-shadow relative" data-z="0.5" data-hover-z="1" data-animated href="/brasfoot/gerenciamento/planodejogo">
            Próxima partida
        </a>
          </div>
        </div>
      ...
      <div class="row" data-toggle="isotope">
        <div class="item col-xs-12 col-lg-6">
          <div class="panel panel-default paper-shadow" data-z="0.5">
            <div class="panel-heading">
              <h4 class="text-headline margin-none">Time</h4>
              <p class="text-subhead text-light">Estatística e outras informações</p>
            </div>
            <ul class="list-group">
              <li class="list-group-item media v-middle">
                <div class="media-body">
                  <a href="website-take-course.html" class="text-subhead list-group-link">Espírito de equipe</a>
                </div>
              ...
              <li class="list-group-item media v-middle">
                <div class="media-body">
                  <a href="website-take-course.html" class="text-subhead list-group-link">Força do time</a>
                </div>
                <div class="media-right">
                  <div class="progress progress-mini width-100 margin-none">
        ...
        <div class="item col-xs-12 col-lg-6">
          ...
          <div class="panel panel-default paper-shadow" data-z="0.5">
            <div class="panel-body">
              <h4 class="text-headline margin-none">Conquistas</h4>
