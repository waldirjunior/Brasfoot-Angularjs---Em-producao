    ...
    <div class="left">
		<div class="content">
			...
			<div class="wrapper">
				<h1 style="font-size: 39px;">Orientações para jogadores</h1>
				<h2>Digite as orientação para passar para os jogadores!</h2>
			...
			<a class="btn-orange" href="#">Voltar para Plano de Jogo</a>
			<a class="btn-ocean" href="/brasfoot/partida/andamento">Ir Para Gramado!</a>
		</div>
    </div>
    <div class="right">
	    <div class="content">
			...
			<main>
			    <div class="static">
			        <h1 class="js-heading">Escalação</h1>
